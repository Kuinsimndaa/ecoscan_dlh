...
const MonthlyReport = () => {
  ...
  const handleExportExcel = () => {
    ...
    const dataExcel = laporan.map((item, index) => ({
      ...
      Mandor: item.mandor,
      'Metode Scan': item.metodeScan || 'QR',
                  ...
                  laporan.map((item, idx) => (
                    ...
                    >
                      ...
                      <td className="px-6 py-5 text-center">
                        {item.metodeScan === 'RFID' ? (
                          <div className="flex flex-col items-center gap-1">
                            <span className="text-xl">📟</span>
                            <span className="text-[9px] font-black text-blue-600 bg-blue-50 px-2 py-0.5 rounded border border-blue-200">RFID</span>
                          </div>
                        ) : (
                          <div className="flex flex-col items-center gap-1">
                            <span className="text-xl">📱</span>
                            <span className="text-[9px] font-black text-green-600 bg-green-50 px-2 py-0.5 rounded border border-green-200">QR CODE</span>
                          </div>
                        )}
                      </td>
                      <td className="px-6 py-5">
