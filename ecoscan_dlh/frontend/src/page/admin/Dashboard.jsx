            ...
            <table className="w-full text-left">
              <thead className="bg-gradient-to-r from-slate-900 to-slate-800 sticky top-0">
                <tr className="text-[13px] font-black text-slate-300 uppercase tracking-[0.15em]">
                  ...
                  <th className="px-10 py-7 text-center">METODE</th>
                      ...
                      <td className="px-10 py-8 text-center">
                        {log.metodeScan === 'RFID' ? (
                          <div className="flex flex-col items-center gap-1">
                            ...
                            <span className="text-[9px] font-black text-blue-600 tracking-tighter bg-blue-50 px-2 py-0.5 rounded border border-blue-200">RFID</span>
                          </div>
                        ) : (
                          <div className="flex flex-col items-center gap-1">
                            <span className="text-2xl">📱</span>
                            <span className="text-[9px] font-black text-green-600 tracking-tighter bg-green-50 px-2 py-0.5 rounded border border-green-200">QR CODE</span>
                          </div>
                        )}
                      </td>
